...
actor ORTSessionManager {
    ...
    ///
    /// - Parameter executionProvider: Preferred execution provider.
    /// - Parameter tuning: Session tuning options (threads, EP flags). Default reads from environment.
    func loadModels(executionProvider: ORTPrimaryExecutionProvider = .cpu, tuning: ORTSessionTuningOptions = .default) async throws {
